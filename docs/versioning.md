...
Established 2026-09-13 from the user's versioning instructions. Read this guide before changing a version or preparing a release. Current release: **0.3.1**, incremented from **0.3.0**.
